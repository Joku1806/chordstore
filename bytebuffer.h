...
typedef struct {
    ...
    uint32_t length;                 // größter Wert, der hier potentiell gespeichert werden muss ist die Länge vom value, deswegen benutze ich hier nur uint32_t, und nicht so etwas wie __uint128_t.
} bytebuffer;
